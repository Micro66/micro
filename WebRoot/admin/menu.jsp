	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>视频分类管理</b></dt>
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>视频推荐信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/gonggao/gonggaoAdd.jsp' target='main'>视频推荐信息添加</a> </li>
	             <li><a href='<%=path %>/gonggaoMana.action' target='main'>视频推荐信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items3_1")'><b>会员评价板</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/liuyanMana.action' target='main'>评价板管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
