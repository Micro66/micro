...
<html>
  ...
  <body>
        <center><img src="<%=path %>/img/banner.gif" width="966"></center>
		<div class="topmenu cbody1">
			<ul>
				...
				<li class="thisclass">
					<A href="<%=path %>/qiantai/musicHistory.jsp">视频推荐信息</A>
				</li>
				<li class="thisclass">
					<A href="#" onclick="myUp()">我要上传</A>
				</li>
				...
				<li class="thisclass">
					<A href="#" onclick="liuyanAll()">我要评价</A>
				</li>
			</ul>
		</div>
			...
			<div class="topsearch">
				...
				<div id="page_search_left">
				   <span style="float:left">
					   视频名：<input class="inputText" id="" size="16" name="name" type="text" />
				        演员:<input class="inputText" id="" size="16" name="geshou" type="text" />
